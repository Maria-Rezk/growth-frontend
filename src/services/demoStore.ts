...
export let demoBrandProfile: BrandProfile = {
  ...
  companyId: demoCompany.id,
  companyName: 'Solu1ions Business Development',
  businessType: 'Business development, marketing, IT and AI services agency',
  services: 'Branding, social media management, CRM, AI automation, PR, events, operations and capacity building.',
  ...
  brandColors: '#c9144b, #2b344f, #f2f2f2, #b3b3b3',
  currentOffers: 'Growth audit, monthly social media package, CRM setup sprint.',
