...
export const messages: Record<AppLanguage, Dictionary> = {
  en: {
    'nav.myWork': 'My work',
    'nav.home': 'Home',
    'nav.group.yourBrand': 'Your brand',
    ...
    'nav.operations': 'Operations dashboard',
  ...
  ar: {
    ...
    'nav.home': 'الرئيسية',
    'nav.group.yourBrand': 'علامتك التجارية',
